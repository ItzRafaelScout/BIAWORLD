...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "eateot1", src: "./img/bonzi/eateot1.png" },
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "green", "purple", "red", "pink", "kamala", "cyan", "yellow", "shadow", "orange", "gray", "white", "deepfry", "FBI", "mametchi", "eateot1", "maidtchi", "biblicalaccurateangel", "pope"], b = 0; b < a.length; b++) {
                        var c = a[b],
