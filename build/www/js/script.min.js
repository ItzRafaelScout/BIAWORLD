...
function setup() {
    // Add markdown and rainbow support
    ...
    // Add rainbow animation and spoiler CSS
    $('<style>')
        .text(`
            .rainbow-text {
    ...
    $("#chat_send").click(sendInput),
        ...
        socket.on("talk", function (a) {
            var b = bonzis[a.guid];
            b.cancel();
            // Process message with markdown before displaying
            a.text = processMessage(a.text);
        ...
        return (
            _createClass(a, [
                ...
                },
                {
                    key: "updateName",
                    value: function () {
                        this.$nametag.html(processMessage(this.userPublic.name));
                    },
                },
                {
                    key: "image",
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "green", "purple", "red", "pink", "kamala", "cyan", "yellow", "shadow", "orange", "gray", "white", "deepfry", "pope"], b = 0; b < a.length; b++) {
                        var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "bonziKamala", "bonziCyan", "bonziYellow", "bonziShadow", "bonziOrange", "bonziGray", "bonziWhite", "bonzi69", "topjej"];
